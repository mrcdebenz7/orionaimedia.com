...
export const metadata: Metadata = {
    ...
    openGraph: { url: 'https://www.orionaimedia.com/method', images: ['/og/method'] },
    twitter: { images: ['/og/method'], card: 'summary_large_image' }
};
            ...
            <main className="relative z-content">
                ...
                <section className="max-w-7xl mx-auto px-4 py-12">
                    <div className="grid gap-6 md:grid-cols-3">
                        {steps.map((step, idx) => (
                            <AnimateInClient key={step.title} className="rounded-panel bg-graphite-800/70 border border-royal-shade/40 p-6 hover:border-pulse-hover/60 transition-colors" delay={0.06 * idx}>
                ...
                <AnimateInClient as="section" className="max-w-7xl mx-auto px-4 py-12" y={20}>
                ...
                <AnimateInClient as="section" id="revamp" className="max-w-7xl mx-auto px-4 py-12 text-center">
